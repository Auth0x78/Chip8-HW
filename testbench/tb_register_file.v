    ...
    initial begin
        ...
        for (i = 0; i < write_test_cnt; i = i + 1) begin
            ...
            if(Vx_out === expected_low) begin
               ...
               $display("[FAIL] Iteration %0d: Write to V[%0d] | Expected = %0d Got = %0d", i, reg_index_x, expected_low, Vx_out);
            end
        ...
        for (i = 0; i < write_test_cnt; i = i + 1) begin
            ...
            if(out === expected_low) begin
               ...
               fail_count = fail_count + 1;
               $display("[FAIL] Iteration %0d: Write to %s | Expected = %0d Got = %0d", i, reg_name, expected_low, out);
            end
        end
        ...
        for (i = 0; i < write_test_cnt; i = i + 1) begin
            ...
            if(I === {expected_high, expected_low}) begin
               ...
               fail_count = fail_count + 1;
               $display("[FAIL] Iteration %0d: Write to Index | Expected = %0d Got = %0d", i, {expected_high, expected_low}, I);
            end
        end

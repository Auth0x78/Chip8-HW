    ...
    initial begin
        ...
        for (i = 0; i < 1000; i = i + 1) begin
            ...
            if ((Z === expected_Z) && (A[0] === expected_A[0])) begin
                ...
                $display("[FAIL] Iter %0d: OP=4'h%0h | Xin=%0d Yin=%0d Rin=%0d | Expected (Z=%0d A[0]=%0b) Got (Z=%0d A[0]=%0b)",
